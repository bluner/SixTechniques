...
import net.mcreator.sixtechniques.procedures.StaminaBarProcedure6Procedure;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.platform.GlStateManager;

@Mod.EventBusSubscriber({Dist.CLIENT})
public class StaminaBar6Overlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (StaminaBarProcedure6Procedure.execute(entity)) {
			...
			event.getGuiGraphics().blit(new ResourceLocation("sixtechniques:textures/screens/smaller_stamina_bar.png"), w / 2 + 56, h / 2 + 86, 0, 0, 16, 16, 16, 16);
