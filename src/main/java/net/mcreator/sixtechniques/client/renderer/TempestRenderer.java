package net.mcreator.sixtechniques.client.renderer;
...
public class TempestRenderer extends EntityRenderer<TempestEntity> {
	...
	public TempestRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelhopefultempestkick(context.bakeLayer(Modelhopefultempestkick.LAYER_LOCATION));
	}

	@Override
	public void render(TempestEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(TempestEntity entity) {
		return texture;
	}
}
