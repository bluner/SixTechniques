...
import net.mcreator.sixtechniques.procedures.BOnKeyPressedProcedure;
...
public class BMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SixtechniquesMod.addNetworkMessage(BMessage.class, BMessage::buffer, BMessage::new, BMessage::handler);
	}
}
